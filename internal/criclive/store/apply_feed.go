...
func (s *Store) applyReconcilingPoll(
	...
	log.Printf(
		"criclive fixture %d match %s: reconciling poll %d reason=%s feed=%s trading=%s blockers=%v cancel=%t",
...
// EnsureAdmittedFixturesPollable marks every admitted non-terminal CricLive match

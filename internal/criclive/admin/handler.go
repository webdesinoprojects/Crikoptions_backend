...
func (h *Handler) Status(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		httpjson.Write(w, http.StatusInternalServerError, map[string]any{"success": false, "message": "Could not load CricLive status"})
		return
	}
...
func (h *Handler) Leagues(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		httpjson.Write(w, http.StatusInternalServerError, map[string]any{"success": false, "message": "Could not load CricLive leagues"})
		return
	}
...
func (h *Handler) SetLeagueEnabled(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		httpjson.Write(w, http.StatusInternalServerError, map[string]any{"success": false, "message": "Could not update CricLive league"})
		return
	}
	if !updated {
